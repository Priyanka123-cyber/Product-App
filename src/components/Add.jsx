...
const Add = ({ props }) => {
  ...
  return (
    <div>
      <h2 style={{ color: '#333', fontSize: '30px', marginBottom: '16px', textAlign: 'left', marginLeft: '110px' }}>Add New Product</h2>
      ...
      <Button
        variant="contained"
        onClick={sendData}
        sx={{ color: 'black', backgroundColor: '#FFBFBF', margin: 2, fontWeight: 20, fontSize: '18px', padding: '12px 24px' }}
      >
        Add Product
      </Button>
    </div>
